...
print('Ques 2 \n ')
n = int(input("Enter number of rows to be in Pascal's Triangle: "))
...
print('\nQues 6\n ')
word = input('Hey 1st friend, you may enter a word: ')

#taking the other input word from the other friend
